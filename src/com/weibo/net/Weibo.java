...
public class Weibo {
	...
	#public static String APP_KEY = "YOUR APP";
	#public static String APP_SECRET = "YOUR SECRET";
	...
	public String request(Context context, String url, WeiboParameters params,
			String httpMethod, AccessToken token) throws WeiboException {
	...
	private void startActivitySignOn(Activity activity, String key,
			String secret) {

	}

	private void startDialogAuth(Activity activity, String app_key,
			String app_secret) {
